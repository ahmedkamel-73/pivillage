...
export async function onRequestGet({request, env}) {
  ...
  let sql="SELECT products.*, shops.name as shop_name FROM products JOIN shops ON products.shop_id=shops.id WHERE products.is_active=1 AND shops.is_active=1";
  let params=[];
